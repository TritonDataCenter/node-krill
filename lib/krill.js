 ...
 * XXX do we never validate that "ge" can't be used on strings and the like?
 */
...
{
	this.name = name;
	this.numeric = types.indexOf('numeric') != -1;
	this.string = types.indexOf('string') != -1;
...
var krillOps = {
	...
	'==', [ 'numeric', 'string' ], function (a, b) { return (a == b); }),
